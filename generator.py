...
class Generator:
    ...
    def createModel(self, imgDim):
        ...
        self.model.add(Deconv2D(16, 3, padding='same', input_shape=(100, 100, 3)))
        self.model.add(BatchNormalization(momentum=0.9))
        self.model.add(Activation('relu'))
        self.model.add(Deconv2D(16, 3, padding='same'))
        self.model.add(BatchNormalization(momentum=0.9))
        self.model.add(Activation('relu'))
        self.model.add(Dropout(0.5))
        self.model.add(Deconv2D(8, 3, padding='same'))
        self.model.add(BatchNormalization(momentum=0.9))
        self.model.add(Activation('relu'))
        self.model.add(Dropout(0.5))
        self.model.add(Deconv2D(8, 3, padding='same'))
        ...
        self.model.add(Activation('relu'))
        self.model.add(Dropout(0.5))
        self.model.add(Deconv2D(4, 3, padding='same'))
        self.model.add(BatchNormalization(momentum=0.9))
        self.model.add(Activation('relu'))
        self.model.add(Dropout(0.5))
        self.model.add(Deconv2D(4, 3, padding='same'))
        ...
        self.model.add(Activation('relu'))
        self.model.add(Dropout(0.5))
        self.model.add(Deconv2D(2, 3, padding='same'))
        self.model.add(BatchNormalization(momentum=0.9))
        self.model.add(Activation('relu'))
        self.model.add(Dropout(0.5))
        self.model.add(Deconv2D(2, 3, padding='same'))
        ...
        self.model.add(Activation('relu'))
        self.model.add(Dropout(0.5))
        self.model.add(Deconv2D(3, 3, padding='same'))
